          ...
          <div className="wrap heroInner">
            ...
            <div className="heroContent">
              ...
              <div className="status">
                <i /> Software Engineer · Backend & Distributed Systems
              </div>

              <h1>
                I build systems<br />
                that <em>keep moving.</em>
              </h1>

              <p className="heroText">
                Java · Spring Boot · Kafka · AWS — engineering microservices,
                event-driven workflows and distributed order-processing systems
                across e-commerce, healthcare and advertising.
              </p>
            ...
            <div className="heroPhoto">
              <img src="/profile.png" alt="Priyanka Soni" />
            </div>
